...
GEMINI_API_KEYS = settings.llm.gemini_api_keys
GEMINI_MODEL = settings.llm.gemini_model
GEMINI_EMBEDDING_MODEL = settings.llm.gemini_embedding_model
GEMINI_RPM = settings.llm.gemini_rpm
GEMINI_TPM = settings.llm.gemini_tpm
GEMINI_RPD = settings.llm.gemini_rpd
GEMINI_TIMEOUT_MS = settings.llm.gemini_timeout_ms
GEMINI_MAX_RETRIES = settings.llm.gemini_max_retries
GEMINI_RETRY_BASE_SECONDS = settings.llm.gemini_retry_base_seconds
GEMINI_RETRY_MAX_SECONDS = settings.llm.gemini_retry_max_seconds
GEMINI_DEFAULT_COOLDOWN_SECONDS = settings.llm.gemini_default_cooldown_seconds
GEMINI_RETRY_CAPACITY_ERRORS_INDEFINITELY = settings.llm.gemini_retry_capacity_errors_indefinitely
