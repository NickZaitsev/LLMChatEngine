...
DEFAULT_PERSONA_CONFIGS = {
    "companion_partner": {
        ...
        "relationship_style": "Close companion who remembers details and shows genuine interest",
        "special_instructions": "Be warm and transparent that you are an AI assistant when it matters"
    },
    "companion": {
        "name": "Alex", 
...
def get_default_persona_config(persona_type: str = "companion_partner") -> Dict[str, Any]:
    ...
    Args:
        persona_type: Type of persona ("companion_partner", "companion", "mentor")
        
    Returns:
        Dictionary containing default persona configuration
    """
    return DEFAULT_PERSONA_CONFIGS.get(persona_type, DEFAULT_PERSONA_CONFIGS["companion_partner"]).copy()
